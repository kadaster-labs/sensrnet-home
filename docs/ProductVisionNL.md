...
Meer over dit concept vind je in in de [systeembeschrijving](SystemDescriptionNL.md) en in de [Architecture](Architecture.md).
...
Hiertoe zijn in 2021 diverse gemeenten gestart met [pilots](Pilots.md). Het Ministrie van Binnenlandse Zaken is daarbij betrokken voor de projectleiding en coördinatie van alle activiteiten. Het doel van de pilots is (oa) meer informatie te verzamelen tbv de opschalingsanalyse van de Vereniging van Nederlandse Gemeentes (VNG). Dit komt begin 2022 tot afronding.

## 2022 en verder

In het eerste kwartaal van 2022 wordt in de input vanuit de [pilots](Pilots.md) verzameld en gebundeld. Dit is het startpunt voor de opschalingsanalyse van de VNG. Daarnaast, parallel en opvolgend wordt door het Ministerie van Binnenlandse Zaken in samenwerking met alle betrokken partijen gewerkt aan een aantal mogelijke scenario's voor het vervolg en implementatie. Een implementatieplan zou de uitkomst van deze exercitie moeten zijn, waarin duidelijk de vervolgstappen staan beschreven. Wordt vervolgd ...

Uiteindelijk is het doel om tot een nationaal sensorenregister te komen en dat kan alleen als deze deels verplichtend is tbv volledigheid en kwaliteit. Wat er echter dan verplicht moet zijn, wie welke rol daarin heeft en hoe dat geborgd kan worden in verordeningen en wetgeving, is nog ongewis.
