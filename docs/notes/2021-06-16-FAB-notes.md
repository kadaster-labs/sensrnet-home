...
3. **Communicatie & Promotie** (Kadaster)
     ...
     - Voor een smart city conferentie in Duitsland is een paper in voorbereiding:
        ...
        > - Het  concept, geschreven door Kadaster, is [hier](https://github.com/kadaster-labs/sensrnet-home/blob/main/docs/2021-06-26-SensRNet-Sensor-Registry-as-a-base-layer-for-smart-cities.pdf) te vinden.
